...
BEGIN_MESSAGE_MAP(CFaceDetectionApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CFaceDetectionApp::OnAppAbout)
	// 基于文件的标准文档命令
...
// 唯一的一个 CFaceDetectionApp 对象

CFaceDetectionApp theApp;


// CFaceDetectionApp 初始化
