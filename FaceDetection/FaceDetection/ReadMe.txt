================================================================================
    MICROSOFT 基础类库: FaceDetection 项目概述
===============================================================================

应用程序向导已为您创建此 FaceDetection 应用程序。此应用程序不仅演示使用 Microsoft 基础类的基本知识，而且可作为编写应用程序的起点。

此文件包含组成 FaceDetection 应用程序的各个文件的内容摘要。
...
FaceDetection.h
    这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CFaceDetectionApp 应用程序类。

FaceDetection.cpp
    这是包含应用程序类 CFaceDetectionApp 的主要应用程序源文件。

FaceDetection.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\FaceDetection.ico
    这是用作应用程序图标的图标文件。此图标包括在主要资源文件 FaceDetection.rc 中。
...
FaceDetectionDoc.h，FaceDetectionDoc.cpp - 文档
    这些文件包含 CFaceDetectionDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CFaceDetectionDoc::Serialize)。

FaceDetectionView.h，FaceDetectionView.cpp - 文档的视图
    这些文件包含 CFaceDetectionView 类。
    CFaceDetectionView 对象用于查看 CFaceDetectionDoc 对象。
