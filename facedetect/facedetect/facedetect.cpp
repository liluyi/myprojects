...
int _tmain(int argc, char** argv)
{
    ...
    if( argc > 1 && strncmp( argv[1], "--cascade=", optlen ) == 0 )//如果输入中包含某个训练集名称和某个输入文件名称
    {
        cascade_name = argv[1] + optlen;//？？？？？？？？？？？？？？
        input_name = argc > 2 ? argv[2] : 0;
    }
    else//装载OpenCV自带的哈尔小波变换Haar训练集
    {
	...
	//input_name="D:/[60分钟]60.Minutes.US.S42E29.2010.05.02.The.All.American.Canal.-.Chef.Jose.Andres.-.Conan.HDTV.XviD-YT_new2.avi" ;////
    ...
    {
		const char* filename = input_name ? input_name : (char*)"C:/Users/Li Luyi/Desktop/testimg/暴风截屏20100528144938.jpg";
